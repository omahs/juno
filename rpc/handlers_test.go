...
func TestEstimateMessageFee(t *testing.T) {
	...
	mockVM.EXPECT().Execute(gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(),
		...
		latestHeader.GasPriceSTRK).DoAndReturn(
		func(txns []core.Transaction, declaredClasses []core.Class, blockNumber, blockTimestamp uint64,
			...
			skipChargeFee, skipValidate, errOnRevert bool, gasPriceWei, gasPriceSTRK *felt.Felt,
...
func TestTraceTransaction(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		...
		mockVM.EXPECT().Execute([]core.Transaction{tx}, []core.Class{declaredClass.Class}, header.Number, header.Timestamp, header.SequencerAddress,
			gomock.Any(), &utils.Mainnet, []*felt.Felt{}, false, false, false, gomock.Any(), gomock.Any()).Return(nil, []vm.TransactionTrace{*vmTrace}, nil)
...
func TestSimulateTransactions(t *testing.T) {
	...
	t.Run("ok with zero values, skip fee", func(t *testing.T) {
		mockVM.EXPECT().Execute(nil, nil, uint64(0), uint64(0), sequencerAddress, mockState, &network, []*felt.Felt{}, true, false, false, nil, nil).
	...
	t.Run("ok with zero values, skip validate", func(t *testing.T) {
		mockVM.EXPECT().Execute(nil, nil, uint64(0), uint64(0), sequencerAddress, mockState, &network, []*felt.Felt{}, false, true, false, nil, nil).
			Return([]*felt.Felt{}, []vm.TransactionTrace{}, nil)
...
func TestTraceBlockTransactions(t *testing.T) {
	...
	t.Run("pending block", func(t *testing.T) {
		...
		mockVM.EXPECT().Execute(block.Transactions, []core.Class{declaredClass.Class}, header.Number, header.Timestamp, sequencerAddress,
			gomock.Any(), &network, paidL1Fees, false, false, false, header.GasPrice, header.GasPriceSTRK).Return(nil, []vm.TransactionTrace{vmTrace, vmTrace}, nil)
	...
	t.Run("regular block", func(t *testing.T) {
		...
		require.NoError(t, json.Unmarshal(vmTraceJSON, &vmTrace))
		mockVM.EXPECT().Execute([]core.Transaction{tx}, []core.Class{declaredClass.Class}, header.Number, header.Timestamp, header.SequencerAddress,
			gomock.Any(), &network, []*felt.Felt{}, false, false, false, header.GasPrice, header.GasPriceSTRK).Return(nil, []vm.TransactionTrace{vmTrace}, nil)
...
func TestEstimateFee(t *testing.T) {
	...
	t.Run("ok with zero values", func(t *testing.T) {
		mockVM.EXPECT().Execute(nil, nil, uint64(0), uint64(0), sequencerAddress, mockState, &network, []*felt.Felt{}, true, false, true, nil, nil).
			Return([]*felt.Felt{}, []vm.TransactionTrace{}, nil)
	...
	t.Run("ok with zero values, skip validate", func(t *testing.T) {
		mockVM.EXPECT().Execute(nil, nil, uint64(0), uint64(0), sequencerAddress, mockState, &network, []*felt.Felt{}, true, true, true, nil, nil).
			Return([]*felt.Felt{}, []vm.TransactionTrace{}, nil)
